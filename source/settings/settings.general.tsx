...
export const SettingsTableGeneral = [
	...
	},
	{
		...
		list: [
			...
			{ key: "Points", title: "Grid::Settings::Points", desc: "Grid::Settings::Points::Desc", type: "ranges", value: [ 1.0 ], params: { min: 0, max: 2, step: 0.01, grid: true, single: true, float: true } },
		]
	}
];